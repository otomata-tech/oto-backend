...
# Accès aux namespaces gouvernés (ADR 0009, fusion *_op) — entitlement org + grant user.
from . import namespace_access  # noqa: F401 — connectors.namespace_access (oto_admin_namespace_access)
